...
setlocale(LC_CTYPE, 'de'); //correct transliteration
...
$config = array(
	...
	*/
	...
	|
	*/
	'upload_dir' => (!isset($_SERVER['CI_ENV']) || $_SERVER['CI_ENV'] == 'development'
	                 ? '1_EB_Zuerich/Repository/Diplomarbeit/diplomgruppe_6/theaterschoenenberg/media/bilder/' 
					 : '/kurs/webprog28/bk/theaterschoenenberg/media/bilder/'),
	/*
	|--------------------------------------------------------------------------
	...
	*/
	...
	|
	*/
	'thumbs_base_path' => '../../../media/thumbnails/',
	...
	*/
	...
	'access_keys' => array('HpPe_F8RLRPi'),
