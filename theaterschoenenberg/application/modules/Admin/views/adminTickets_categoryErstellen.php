...
<div>
  ...
  <div class="container">
    ...
    <h2>Neuen Tickettyp Erstellen</h2>
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        ...
        echo form_open( base_url() . 'Admin/Backend_Tickets/createTicketCategory',
                       $a_attributes);
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        <?php
        // Formular absenden
        echo form_submit('ticket_category_create',
                         'Speichern',
                         'id="ticket_category_create"
        ...
        $url = '<a href="' .
               ...
               'Admin/Backend_Tickets' .
     			     '"' .
               'class="button-link ticket_category_create-zurueck">Zurück</a>';
        echo $url;
