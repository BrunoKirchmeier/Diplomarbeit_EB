<div class="auth">
  ...
  <div class="auth-editUser container">

    <div class="auth-editUser row">

      <!-- Bootstrap Spalte 1 -->
      <div class="auth-editUser col-md-2"></div>

      <!-- Bootstrap Spalte 2 (immer sichtbar) -->
      <div class="auth-editUser col-md-8 col-12">

        <h1>Account Daten ändern</h1>
        <br><br>
        ...
        // Formular öffnen
        echo form_submit('accountSpeichern', 'Änderungen Speichern', 'id="editUser" class="button button-link"');
