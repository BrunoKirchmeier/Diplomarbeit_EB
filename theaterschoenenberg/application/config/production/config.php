...
|
*/
$config['base_url'] = 'https://pingu.eb-zuerich.ch/kurs/webprog28/bk/theaterschoenenberg/';
...
|
*/
$config['encryption_key'] = 'aG-.wORH1?64';
...
$config['sess_cookie_name']        = 'prod_theater_session';
$config['sess_expiration']         = 7200;
$config['sess_save_path']          = 'theater_session';
