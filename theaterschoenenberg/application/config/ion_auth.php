...
$config['admin_email']                = "HansMusterSTMP@gmail.com"; // Admin Email, admin@example.com
...
/** Email Server Einstellungen anhand Server Umgebung */
if(isset($_SERVER['CI_ENV']) ) {


	$config['email_config'] = $_SERVER['CI_ENV'] == 'development'
													? array('protocol' => 'smtp',
																							 	'mailpath' => 'C:/xampp/sendmail/sendmail.exe -t',
																								'smtp_host' => 'ssl://smtp.gmail.com',
																								'smtp_user' => 'HansMusterSTMP@gmail.com',
																								'smtp_pass' => '@smtptEST-email1985',
																								'smtp_port' => '465',
																								'smtp_timeout' => '5',
																								'mailtype' => 'html')
													: array('protocol' => 'sendmail',
